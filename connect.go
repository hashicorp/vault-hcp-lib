...
func (c *HCPConnectCommand) Flags() *flag.FlagSet {
	...
	mainSet.Var(&stringValue{target: &c.flagClientID}, "client-id", "")
	mainSet.Var(&stringValue{target: &c.flagSecretID}, "secret-id", "")
	mainSet.Var(&stringValue{target: &c.flagOrganizationID}, "organization-id", "")
	mainSet.Var(&stringValue{target: &c.flagProjectID}, "project-id", "")
	mainSet.Var(&stringValue{target: &c.flagClusterID}, "cluster-id", "")
